...
export default class LeafletActiveLayersTools extends vendor.L.Control {
  ...
  onAdd () {
    ...
    if (zoomEnabled) {
      this._zoomLink = vendor.L.DomUtil.create('a', 'leaflet-control-disabled', container)
    ...
    if (clearEnabled) {
      this._clearLink = vendor.L.DomUtil.create('a', 'leaflet-control-disabled', container)
    ...
    if (reorderEnabled) {
      this._reorderLink = vendor.L.DomUtil.create('a', 'leaflet-control-disabled', container)
