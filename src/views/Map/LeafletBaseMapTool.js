...
export default class LeafletBaseMapTool extends vendor.L.Control {
  ...
  onAdd () {
    ...
    this._basemapLink = vendor.L.DomUtil.create('a', '', container)
    ...
    this.enable = () => {
      ...
      if (vendor.L.DomUtil.hasClass(this._basemapLink, 'leaflet-control-disabled')) {
        vendor.L.DomUtil.removeClass(this._basemapLink, 'leaflet-control-disabled')
      }
    }
