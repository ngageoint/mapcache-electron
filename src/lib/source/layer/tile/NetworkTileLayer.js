...
export default class NetworkTileLayer extends TileLayer {
  constructor (configuration = {}) {
    super(configuration)
    this.rateLimit = this._configuration.rateLimit || HttpUtilities.DEFAULT_RATE_LIMIT
    this.retryAttempts = !isNil(this._configuration.retryAttempts) ? this._configuration.retryAttempts : HttpUtilities.DEFAULT_RETRY_ATTEMPTS
    this.timeoutMs = !isNil(this._configuration.timeoutMs) ? this._configuration.timeoutMs : HttpUtilities.DEFAULT_TIMEOUT
  }
