<template>
  <v-list subheader>
    <v-dialog
      ...
      <m-b-style-editor title="Point style" :geometryType="1" :styleObject="configuration.pointStyle"
                        :save="updatePointStyle" :close="() => {showPointStyleEditor = false}"></m-b-style-editor>
    </v-dialog>
    <v-dialog
      ...
      <m-b-style-editor title="Line style" :geometryType="2" :styleObject="configuration.lineStyle"
                        :save="updateLineStringStyle"
                        :close="() => {showLineStringStyleEditor = false}"></m-b-style-editor>
    </v-dialog>
    <v-dialog
    ...
    <v-list-item class="pt-2">
      <div>
        <v-row no-gutters justify="space-between" align="center">
          ...
          <v-btn icon @click="showPointStyleEditor = true">
            <geometry-style-svg :geometry-type="1" :color="configuration.pointStyle.color"
                                :fill-color="configuration.pointStyle.fillColor"
    ...
    <v-list-item class="pt-2">
      <div>
        <v-row no-gutters justify="space-between" align="center">
          ...
          <v-btn icon @click="showLineStringStyleEditor = true">
            <geometry-style-svg :geometry-type="2" :color="configuration.lineStyle.color"
                                :fill-color="configuration.lineStyle.fillColor"
    ...
    <v-list-item class="pt-2">
      <div>
        <v-row no-gutters justify="space-between" align="center">
          ...
          <v-btn icon @click="showPolygonStyleEditor = true">
            <geometry-style-svg :geometry-type="3" :color="configuration.polygonStyle.color"
                                :fill-color="configuration.polygonStyle.fillColor"
