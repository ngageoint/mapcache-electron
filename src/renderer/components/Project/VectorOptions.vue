...
<!--        </div>-->
<!--      </div>-->
      <div class="layer__face__stats" v-if="styleRows.length > 0">
        <p class="layer__face__stats__weight">
          Feature Styles
        </p>
        <ul>
      ...
      <div class="layer__face__stats" v-if="iconRows.length > 0">
        <p class="layer__face__stats__weight">
          Feature Icons
        </p>
        <ul>
...
<script>
  ...
  export default {
    ...
    data () {
      ...
      return {
        features: this.layer.featureCollection ? this.layer.featureCollection.features : [],
        pointIconOrStyle: this.layer.style.default.iconOrStyle['Point'],
        pointIconId: this.layer.style.default.icons['Point'] + '',
        pointStyleId: this.layer.style.default.styles['Point'] + '',
        lineStringStyleId: this.layer.style.default.styles['LineString'] + '',
        polygonStyleId: this.layer.style.default.styles['Polygon'] + '',
        maxFeatures: this.layer.style.maxFeatures,
        styleRows: Object.keys(styleRows),
        iconRows: Object.keys(iconRows)
      }
    },
    components: {
